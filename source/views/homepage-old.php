              ...
              <div class="carousel-inner" role="listbox">
                <?php foreach ($featured_images as $featured_image):?>
                  <div class="carousel-item">
                    <img class="d-block img-fluid" src="<?php echo 'https://api.universalequipamento.com.br/static/images/' . $featured_image->image_url; ?>" alt="<?php echo $featured_image->description; ?>">
                  </div>
                <?php endforeach; ?>
              </div>
              ...
              <?php foreach ($products as $equipment):?>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                  ...
                  <div class="card-body">
                    ...
                    Ano: <?php echo $equipment->manufacturing; ?>
                  </div>
